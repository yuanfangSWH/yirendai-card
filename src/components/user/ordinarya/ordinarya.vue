<template>
  <div class="layer">
    ...
    <!-- 列表-->
    <div class="liebjl">
      <div class="lbtn">申卡记录</div>
      <div class="lbenr">
        <div class="tmldql" style="background:#ffffff;">
          <div class="li">编号</div>
          <div class="li">申卡手机号码</div>
          <div class="li">申卡银行</div>
          <div class="li">卡种名称</div>
          <div class="li">标签内容</div>
          <div class="li">申卡状态</div>
          <div class="li">申卡日期</div>
        </div>
        <div class="tmldql" v-for="(item,key) in cardData2" :key="key">
          ...
          <div class="li"><span v-if="item.apply_status==1">审核成功</span><span v-else-if="item.apply_status==2">注册成功</span><span v-else>失效</span></div>
