<template>
  <div class="layer">
    ...
    <div class="search-div">
      <router-link to="/bannaertj">
        <div class="tjia">添加banner</div>
      </router-link>
    </div>
    <!-- 列表 -->
    <div class="list-div">
      ...
      <div class="l-nr-a" v-show="state==1">
        ...
        <div class="title" v-for="(item,key) in cardData" :key="key">
          <div class="li">{{item.banner_id}}</div>
          <div class="li">
            <img :src="item.banner_img" />
          </div>
          <div class="li">{{item.type.banner_cate_name}}</div>
          <div class="li">{{item.banner_status}}</div>
          <div class="li">{{item.created_at}}</div>
          <div class="li">{{item.banner_sort}}</div>
          <div class="li">
      ...
      <div class="l-nr-b" v-show="state==2">
        ...
        <div class="title" v-for="(item,key) in cardData" :key="key">
          ...
          <div class="li">
            ...
            <span class="li-abq1" @click="skbj(item)">编辑</span>
...
export default {
  ...
  methods: {
    ...
    ShelvesAPI(value) {
      var data = {
        banner_id: this.valueData.banner_id,
        banner_status: value
      };
      this.api.apiPost(
        "/banner/pullos",
