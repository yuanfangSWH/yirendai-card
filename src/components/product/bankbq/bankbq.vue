  ...
  <div class="layer">
    ...
    <div class="black-div" v-if="exitBounced">
      <div class="bounced">
        ...
        <div class="b-nr">
          <dl>确定要下架【{{xuanzdshuj.bank_tab_name}}】吗？</dl>
          <div class="b-ann">
    ...
    <div class="black-div" v-if="exitBounced2">
      <div class="bounced">
        ...
        <div class="b-nr">
          <dl>确定要上架【{{xuanzdshuj.bank_tab_name}}】吗？</dl>
          <div class="b-ann">
    ...
    <div class="black-div" v-if="exitBounced3">
      <div class="bounced">
        ...
        <div class="b-nr">
          <dl>确定要删除【{{xuanzdshuj.bank_tab_name}}】吗？</dl>
          <div class="b-ann">
    ...
    <div class="list-div">
      ...
      <div class="l-nr-a" v-show="state==1">
        ...
        <div class="title" v-for="(item,key) in cardData1" :key="key">
          <div class="li">{{item.bank_tab_id}}</div>
          <div class="li">{{item.bank_tab_name}}</div>
          <div class="li">{{item.bank_tab_time}}</div>
          <div class="li">{{item.bank_tab_status}}</div>
          <div class="li">{{item.bank_tab_sort}}</div>
          <div class="li">
      ...
      <div class="l-nr-b" v-show="state==2">
        ...
        <div class="title" v-for="(item,key) in cardData2" :key="key">
          ...
          <div class="li">
            ...
            <span class="li-abq1" @click="skbj(item.bank_tab_id)">编辑</span>
...
//加载数据
    loadingData() {
      ...
      this.api.apiPost(
        ...
        (status, judge, res) => {
          if (status) {
            if (this.status == 1) {
              this.cardData1 = res.data.tab;
            } else {
              this.cardData2 = res.data.tab;
            }
            //总数据量
    ...
    ShelvesAPI(value) {
      var data = {
        bank_tab_id: this.xuanzdshuj.bank_tab_id,
        bank_tab_status: value
      };
      this.api.apiPost(
        "/banktab/pullos",
        "post",
