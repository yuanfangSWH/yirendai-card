<template>
  <div class="layer">
    ...
    <div class="black-div" v-if="exitBounced">
      <div class="bounced">
        <div class="b-bt">
          <div class="b-wz1">标签下架</div>
        </div>
        <div class="b-nr">
          <dl>确定要下架【{{xuanzdshuj.bank_label_name}}】吗？</dl>
          <div class="b-ann">
    ...
    <div class="black-div" v-if="exitBounced2">
      <div class="bounced">
        <div class="b-bt">
          <div class="b-wz1">标签上架</div>
        </div>
        <div class="b-nr">
          <dl>确定要上架【{{xuanzdshuj.bank_label_name}}】吗？</dl>
          <div class="b-ann">
    ...
    <div class="black-div" v-if="exitBounced3">
      <div class="bounced">
        <div class="b-bt">
          <div class="b-wz1">标签删除</div>
        </div>
        <div class="b-nr">
          <dl>确定要删除【{{xuanzdshuj.bank_label_name}}】吗？</dl>
          <div class="b-ann">
    ...
    <div class="search-div">
      <router-link to="/labeltj">
        <div class="tjia">添加标签</div>
      </router-link>
    </div>
    <!-- 列表 -->
    <div class="list-div">
      ...
      <div class="l-nr-a" v-show="state==1">
        ...
        <div class="title" v-for="(item,key) in cardData1" :key="key">
          <div class="li">{{item.bank_label_id}}</div>
          <div class="li">{{item.bank_label_name}}</div>
          <div class="li">{{item.bank_label_time}}</div>
          <div class="li">{{item.bank_label_status}}</div>
          <div class="li">{{item.bank_label_sort}}</div>
          <div class="li">
      ...
      <div class="l-nr-b" v-show="state==2">
        ...
        <div class="title" v-for="(item,key) in cardData2" :key="key">
          ...
          <div class="li">
            ...
            <span class="li-abq1" @click="skbj(item.bank_label_id)">编辑</span>
...
export default {
  ...
  methods: {
    ...
    loadingData() {
      ...
      this.api.apiPost(
        ...
        (status, judge, res) => {
          if (status) {
            if (this.status == 1) {
              this.cardData1 = res.data.lable;
            } else {
              this.cardData2 = res.data.lable;
            }
            //总数据量
    ...
    ShelvesAPI(value) {
      var data = {
        bank_label_id: this.xuanzdshuj.bank_label_id,
        bank_label_status: value
      };
      this.api.apiPost(
        "/lable/pullos",
        "post",
