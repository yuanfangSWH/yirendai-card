  ...
  mounted() {
    ...
    this.api.apiPost(
      ...
      (status, judge, res) => {
        if (status) {
          //id
          this.idData = res.data.article.article_id;
          //标题
          this.goodsData = res.data.article.article_title;
          //排序
          this.sortData = res.data.article.article_sort;
          //精品
          this.fineData = res.data.article.article_boutique;
          //分类
          this.chooseData = res.data.article.category_id;
          //封面
          this.portrait = res.data.article.article_cover;
          //内容
          this.nrData = res.data.article.article_content;
          editor.txt.html(this.nrData);
        } else {
          this.$message({
            showClose: true,
            message: res.message,
