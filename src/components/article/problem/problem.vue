<template>
  <div class="layer">
    ...
    <div class="black-div" v-if="exitBounced">
      <div class="bounced">
        <div class="b-bt">
          <div class="b-wz1">问题下架</div>
        </div>
        <div class="b-nr">
          <dl>确定要下架【{{xuanzdshuj.m_faq_title}}】吗？</dl>
          <div class="b-ann">
    ...
    <div class="black-div" v-if="exitBounced2">
      <div class="bounced">
        <div class="b-bt">
          <div class="b-wz1">问题上架</div>
        </div>
        <div class="b-nr">
          <dl>确定要上架【{{xuanzdshuj.m_faq_title}}】吗？</dl>
          <div class="b-ann">
    ...
    <div class="black-div" v-if="exitBounced3">
      <div class="bounced">
        <div class="b-bt">
          <div class="b-wz1">问题删除</div>
        </div>
        <div class="b-nr">
          <dl>确定要删除【{{xuanzdshuj.m_faq_title}}】吗？</dl>
          <div class="b-ann">
    ...
    <div class="search-div">
      <router-link to="/problemtj">
        <div class="tjia">添加问题</div>
      </router-link>
    </div>
    <!-- 列表 -->
    <div class="list-div">
      ...
      <div class="l-nr-a" v-show="state==1">
        ...
        <div class="title" v-for="(item,key) in cardData" :key="key">
          <div class="li">{{item.m_faq_id}}</div>
          <div class="li">{{item.m_faq_title}}</div>
          <div class="li">{{item.updated_at}}</div>
          <div class="li">{{item.m_faq_status}}</div>
          <div class="li">{{item.m_faq_sort}}</div>
          <div class="li">
      ...
      <div class="l-nr-b" v-show="state==2">
        ...
        <div class="title" v-for="(item,key) in cardData" :key="key">
          ...
          <div class="li">
            ...
            <span class="li-abq1" @click="skbj(item.m_faq_id)">编辑</span>
...
export default {
  ...
  methods: {
    ...
    ShelvesAPI(value) {
      var data = {
        m_faq_id: this.xuanzdshuj.m_faq_id,
        m_faq_status: value
      };
      this.api.apiPost(
        "/problem/pullos",
