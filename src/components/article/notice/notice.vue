<template>
  <div class="layer">
    ...
    <div class="black-div" v-if="exitBounced">
      <div class="bounced">
        <div class="b-bt">
          <div class="b-wz1">通知下架</div>
        </div>
        <div class="b-nr">
          <dl>确定要下架【{{xuanzdshuj.m_notice_title}}】吗？</dl>
          <div class="b-ann">
    ...
    <div class="black-div" v-if="exitBounced2">
      <div class="bounced">
        <div class="b-bt">
          <div class="b-wz1">通知上架</div>
        </div>
        <div class="b-nr">
          <dl>确定要上架【{{xuanzdshuj.m_notice_title}}】吗？</dl>
          <div class="b-ann">
    ...
    <div class="black-div" v-if="exitBounced3">
      <div class="bounced">
        <div class="b-bt">
          <div class="b-wz1">通知删除</div>
        </div>
        <div class="b-nr">
          <dl>确定要删除【{{xuanzdshuj.m_notice_title}}】吗？</dl>
          <div class="b-ann">
    ...
    <div class="search-div">
      <router-link to="/noticetj">
        <div class="tjia">添加通知</div>
      </router-link>
    </div>
    <!-- 列表 -->
    <div class="list-div">
      ...
      <div class="l-nr-a" v-show="state==1">
        ...
        <div class="title" v-for="(item,key) in cardData" :key="key">
          <div class="li">{{item.m_notice_id}}</div>
          <div class="li">{{item.m_notice_title}}</div>
          <div class="li">{{item.updated_at}}</div>
          <div class="li">{{item.m_notice_status}}</div>
          <div class="li"><span v-if="item.is_stick=='1'">是</span><span v-else>否</span></div>
          <div class="li">
      ...
      <div class="l-nr-b" v-show="state==2">
        ...
        <div class="title" v-for="(item,key) in cardData" :key="key">
          ...
          <div class="li">
            ...
            <span class="li-abq1" @click="skbj(item.m_notice_id)">编辑</span>
...
export default {
  ...
  methods: {
    ...
    ShelvesAPI(value) {
      var data = {
        m_notice_id: this.xuanzdshuj.m_notice_id,
        m_notice_status: value
      };
      this.api.apiPost(
        "/notice/pullos",
        "post",
