...
export default {
  ...
  mounted() {
    ...
    this.api.apiPost(
      ...
      (status, judge, res) => {
        if (status) {
          this.idData = res.data.m_faq_id;
          this.goodsData = res.data.m_faq_title;
          this.nrData = res.data.m_faq_content;
          this.numberData = res.data.m_faq_sort;
